...
class StringId:
    ...
    BanDocumentation = "/ban <user1> <user2> ... - Ban user(s) from your current room"
    ...
    KickDocumentation = "/kick <user1> <user2> ... - Kick user(s) from your current room"
    ...
    CreateDocumentation = "/create <room name> - Create a new room."
    ...
    FireDocumentation = "/fire <user1> <user2> ... - Revoke Admin privileges for user(s)"
    ...
    HireDocumentation = "/hire <user1> <user2> ... - Make user(s) Admin of your current room"
