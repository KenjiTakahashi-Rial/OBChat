...
class StringId:
    ...
    Unlimited = "Unlimited "
    BanPeer = (
        "{0} is an {1}, so you can't ban them. Feel free to /elevate your complaints to someone who has more authority."
    )
    ...
    AnonElevating = (
        "Why don't you make an account or log in first? Call us old-fashioned, but anons have very little privileges "
        "around these parts."
    )
    NonAdminElevating = (
        "Elevation is a skill that only Admins are capable of wielding. You have yet to reach the level of Admin - "
    ...
    NonAdminKicking = (
        "That's a little outside your pay-grade. Only admins may kick users. Try to /apply to be an Admin."
    )
    KickSyntax = "Usage: /kick <user1> <user2> ..."
    KickSelf = "You can't kick yourself. Just leave the room. Or put yourself on time-out."
    KickPeer = (
        "{0} is an {1}, so you can't kick them. Feel free to /elevate your complaints to someone who has more "
        "authority."
    )
    ...
    NonAdminLifting = (
        "A mere mortal like yourself does not have the power to lift bans. Try to /apply to be an Admin and perhaps "
        "you may obtain this power if you are worthy."
    )
    LiftSyntax = "Usage: /lift <user1> <user2> ..."
    LiftInvalidTarget = (
        "No user named {0} has been banned from this room. How can one lift that which has not been banned?"
    )
    LiftInsufficientPermission = (
        "{0} was banned by {1}. You cannot lift a ban issued by a user of equal or higher privilege than yourself. If "
        "you REALLY want to lift this ban you can /elevate to a higher authority."
    )
    ...
    NonUnlimitedAdminFiring = (
        "That's a little outside your pay-grade. Only Unlimited Admins may fire admins. Try to /apply to be Unlimited."
    )
    ...
    FirePeer = (
        "{0} is an Unlimited Admin, so you can't fire them. Please direct all complaints to your local room owner, I'm "
        "sure they'll love some more paperwork to do..."
    )
    ...
    NonUnlimitedAdminHiring = (
        "That's a little outside your pay-grade. Only Unlimited Admins may hire admins. Try to /apply to be Unlimited."
    )
    ...
    PrivateInvalidTarget = "{0} doesn't exist. Your private message will broadcast into space instead."
